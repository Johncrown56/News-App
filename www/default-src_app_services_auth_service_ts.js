(self["webpackChunknewsApp"] = self["webpackChunknewsApp"] || []).push([["default-src_app_services_auth_service_ts"],{
...
let AuthService = class AuthService {
    ...
    getUserData() {
        this.storageService.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.authKey).then(res => {
            console.log(res);
    ...
    // logout user 
    logout() {
        this.storageService.removeItem(_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.authKey).then(res => {
            this.userData$.next('');
...
let HttpService = class HttpService {
    ...
    errorHandler(error) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.throwError)(error.message || error);
    }
    post(serviceName, data) {
        ...
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiBaseURL + serviceName;
        return this.http.post(url, JSON.stringify(data), options).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(this.errorHandler));
    }
    postNews(serviceName, data) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpHeaders();
        const header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpHeaders({
            'Cache-Control': 'no-cache, no-store, must-revalidate, post-check=0, pre-check=0',
            'Pragma': 'no-cache',
        ...
        const options = { headers: headers, withCredentials: false };
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiBaseURL + serviceName;
        return this.http.post(url, data, options).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(this.errorHandler));
    }
    get(serviceName) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpHeaders();
        const header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpHeaders({
        ...
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.apiBaseURL + serviceName;
        //console.log(url);
        return this.http.get(url, options).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(this.errorHandler));
    }
    getNews(serviceName) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpHeaders({
        ...
        const options = { headers: headers, withCredentials: false };
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.newsApiBaseURL + serviceName;
        return this.http.get(url, options).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(this.errorHandler));
    }
};
...
HttpService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
let StorageService = class StorageService {
    ...
    get(storageKey) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            const res = yield _capacitor_storage__WEBPACK_IMPORTED_MODULE_0__.Storage.get({ key: storageKey });
            if (res.value) {
                // decrypt the value
