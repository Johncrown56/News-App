(self["webpackChunknewsApp"] = self["webpackChunknewsApp"] || []).push([["common"],{
...
let DataService = class DataService {
    ...
    getAllNews(NewsData) {
        return this.httpService.getNews(NewsData + '&apiKey=' + _environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.newsAPI);
    }
    addNews(postData) {
        return this.httpService.postNews('create/news', postData);
    }
    getPersonalNews(userid) {
        var date = new Date().getTime();
        return this.httpService.get('view/news/' + userid + '?date=' + date);
    }
    updatePersonalNews(updatedData) {
        return this.httpService.postNews('update/news', updatedData);
    }
    updatePersonalNews2(updatedData) {
        return this.httpService.post('update/news', updatedData);
    }
    deletePersonalNews(newsid) {
...
let ToastService = class ToastService {
    ...
    presentToastWithOptions(toastMessage) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            const toast = yield this.toastController.create({
                header: 'Information',
                message: toastMessage,
