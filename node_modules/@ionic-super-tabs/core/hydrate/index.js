...
const superTabButtonComponentCss = "/*!@:host*/.sc-super-tab-button-h{-ms-flex:1 0 0px;flex:1 0 0;cursor:pointer;position:relative;max-width:100%;overflow:hidden;display:-ms-flexbox;display:flex;-ms-flex-flow:column nowrap;flex-flow:column nowrap;-ms-flex-align:center;align-items:center;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-sizing:border-box;box-sizing:border-box;-webkit-transform:translate3d(0, 0, 0);transform:translate3d(0, 0, 0);height:72px;padding:0 24px;-webkit-touch-callout:none;-webkit-user-select:none;-webkit-text-size-adjust:none;-webkit-tap-highlight-color:rgba(0, 0, 0, 0);-webkit-font-smoothing:antialiased}/*!@:host ion-label, :host ion-icon, :host ::slotted(ion-label), :host ::slotted(ion-icon)*/.sc-super-tab-button-h ion-label.sc-super-tab-button,.sc-super-tab-button-h ion-icon.sc-super-tab-button,.sc-super-tab-button-h .sc-super-tab-button-s>ion-label,.sc-super-tab-button-h .sc-super-tab-button-s>ion-icon{-webkit-transition-property:all;transition-property:all;-webkit-transition-duration:300ms;transition-duration:300ms;-webkit-transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);-webkit-transition-delay:0s;transition-delay:0s;-webkit-box-sizing:content-box !important;box-sizing:content-box !important;-webkit-user-select:none;-webkit-text-size-adjust:none;-webkit-tap-highlight-color:rgba(0, 0, 0, 0);-webkit-font-smoothing:antialiased}/*!@:host ion-label, :host ::slotted(ion-label)*/.sc-super-tab-button-h ion-label.sc-super-tab-button,.sc-super-tab-button-h .sc-super-tab-button-s>ion-label{color:var(--st-label-color-inactive, var(--st-base-color-inactive));line-height:var(--st-label-line-height, 14px);height:var(--st-label-height, 14px);font-size:var(--st-label-font-size, 14px);text-transform:var(--st-label-text-transform, uppercase);font-weight:var(--st-label-font-weight, 500);padding-bottom:var(--st-label-padding-bottom, 16px)}/*!@:host ion-icon, :host ::slotted(ion-icon)*/.sc-super-tab-button-h ion-icon.sc-super-tab-button,.sc-super-tab-button-h .sc-super-tab-button-s>ion-icon{color:var(--st-icon-color-inactive, var(--st-base-color-inactive));fill:var(--st-icon-color-inactive, var(--st-base-color-inactive));min-height:var(--st-icon-size, 24px);min-width:var(--st-icon-size, 24px);font-size:var(--st-icon-size, 24px);padding-top:12px}@media (hover: hover){/*!@:host(:hover)*/.sc-super-tab-button-h:hover{background:rgba(var(--ion-color-contrast-rgb), 0.04)}}/*!@:host(.active) ion-label, :host(.active) ion-icon, :host(.active) ::slotted(ion-label), :host(.active) ::slotted(ion-icon)*/.active.sc-super-tab-button-h ion-label.sc-super-tab-button,.active.sc-super-tab-button-h ion-icon.sc-super-tab-button,.sc-super-tab-button-h.active .sc-super-tab-button-s>ion-label,.sc-super-tab-button-h.active .sc-super-tab-button-s>ion-icon{-webkit-transition-delay:75ms;transition-delay:75ms}/*!@:host(.active) ion-label, :host(.active) ::slotted(ion-label)*/.active.sc-super-tab-button-h ion-label.sc-super-tab-button,.sc-super-tab-button-h.active .sc-super-tab-button-s>ion-label{color:var(--st-label-color-active, var(--st-base-color-active))}/*!@:host(.active) ion-icon, :host(.active) ::slotted(ion-icon)*/.active.sc-super-tab-button-h ion-icon.sc-super-tab-button,.sc-super-tab-button-h.active .sc-super-tab-button-s>ion-icon{color:var(--st-icon-color-active, var(--st-base-color-active));fill:var(--st-icon-color-active, var(--st-base-color-active))}/*!@:host(.icon-only), :host(.label-only)*/.icon-only.sc-super-tab-button-h,.label-only.sc-super-tab-button-h{height:48px;-ms-flex-pack:center;justify-content:center}/*!@:host(.scrollableContainer)*/.scrollableContainer.sc-super-tab-button-h{-ms-flex-positive:0;flex-grow:0;-ms-flex-preferred-size:auto;flex-basis:auto;min-width:90px;max-width:360px}/*!@::slotted*/.sc-super-tab-button-h{-ms-flex-negative:1;flex-shrink:1}/*!@:host(.label-only) ion-label, :host(.label-only) ::slotted(ion-label)*/.label-only.sc-super-tab-button-h ion-label.sc-super-tab-button,.sc-super-tab-button-h.label-only .sc-super-tab-button-s>ion-label{padding-bottom:0}/*!@:host(.icon-only) ion-icon, :host(.icon-only) ::slotted(ion-icon)*/.icon-only.sc-super-tab-button-h ion-icon.sc-super-tab-button,.sc-super-tab-button-h.icon-only .sc-super-tab-button-s>ion-icon{padding-top:0}";
...
class SuperTabButtonComponent {
    ...
    static get style() { return superTabButtonComponentCss; }
    static get cmpMeta() { return {
        ...
        "$listeners$": undefined,
        "$lazyBundleIds$": "-",
        "$attrsToReflect$": [["active", "active"], ["index", "index"], ["disabled", "disabled"]]
    }; }
}

const superTabComponentCss = "/*!@:host*/.sc-super-tab-h{height:var(--super-tab-height, 100%);position:relative;display:block;overflow-x:hidden;overflow-y:auto;contain:size style;z-index:1;-ms-flex-negative:0;flex-shrink:0;-ms-flex-positive:0;flex-grow:0;width:var(--super-tab-width, 100vw);-webkit-transform:translate3d(0, 0, 0);transform:translate3d(0, 0, 0);-webkit-box-sizing:border-box;box-sizing:border-box;-ms-flex-order:-1;order:-1;-webkit-user-select:none;-webkit-touch-callout:none;-webkit-text-size-adjust:none;-webkit-tap-highlight-color:rgba(0, 0, 0, 0);-webkit-font-smoothing:antialiased}/*!@:host[noScroll]*/[noScroll].sc-super-tab-h{overflow-y:hidden}/*!@ion-nav, ion-content*/ion-nav.sc-super-tab,ion-content.sc-super-tab{height:100%;max-height:100%;position:absolute}/*!@ion-nav > .ion-page, ion-content > .ion-page*/ion-nav.sc-super-tab>.ion-page.sc-super-tab,ion-content.sc-super-tab>.ion-page.sc-super-tab{position:absolute}";
...
class SuperTabIndicatorComponent {
    ...
    static get style() { return superTabIndicatorComponentCss; }
    static get cmpMeta() { return {
        "$flags$": 9,
...
class SuperTabsComponent {
    ...
    static get style() { return superTabsComponentCss; }
    static get cmpMeta() { return {
        "$flags$": 9,
        "$tagName$": "super-tabs",
        "$members$": {
...
class SuperTabsContainerComponent {
    ...
    get el() { return getElement(this); }
    static get style() { return superTabsContainerComponentCss; }
    static get cmpMeta() { return {
        "$flags$": 9,
...
class SuperTabsToolbarComponent {
    ...
    render() {
        return (h(Host, { role: "navigation", class: this.hostCls }, h("div", { class: "buttons-container", ref: (ref) => this.setButtonsContainerEl(ref) }, h("slot", null), this.showIndicator &&
    ...
    static get style() { return superTabsToolbarComponentCss; }
    static get cmpMeta() { return {
        "$flags$": 9,
        ...
        "$lazyBundleIds$": "-",
        "$attrsToReflect$": [["scrollable", "scrollable"], ["scrollablePadding", "scrollable-padding"]]
    }; }
}
