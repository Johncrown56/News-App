...
const index = require('./index-3820b909.js');
const utils = require('./utils-fd04c665.js');
...
class SuperTabsToolbarComponent {
    ...
    moveContainer(scrollX, animate) {
        ...
        utils.scrollEl(this.buttonsContainerEl, scrollX, 0, this.config.nativeSmoothScroll, animate ? this.config.transitionDuration : 0);
        return Promise.resolve();
    }
    getButtonFromEv(ev) {
    ...
    async onTouchMove(ev) {
        ...
        requestAnimationFrame(() => {
            ...
            // scroll container
            const scrollX = utils.getNormalizedScrollX(this.buttonsContainerEl, this.buttonsContainerEl.clientWidth, deltaX);
    ...
    adjustContainerScroll(animate) {
        ...
        if (!animate) {
            utils.scrollEl(this.buttonsContainerEl, pos, 0, false, 50);
        }
        else {
    ...
    render() {
        return (index.h(index.Host, { role: "navigation", class: this.hostCls }, index.h("div", { class: "buttons-container", ref: (ref) => this.setButtonsContainerEl(ref) }, index.h("slot", null), this.showIndicator &&
            index.h("super-tab-indicator", { ref: (ref) => this.indicatorEl = ref, toolbarPosition: this.el.assignedSlot.name }))));
    }
    get el() { return index.getElement(this); }
