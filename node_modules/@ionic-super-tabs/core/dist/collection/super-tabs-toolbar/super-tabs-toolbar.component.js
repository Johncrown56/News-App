...
import { checkGesture, debugLog, getNormalizedScrollX, pointerCoord, scrollEl } from '../utils';
export class SuperTabsToolbarComponent {
    ...
    render() {
        return (h(Host, { role: "navigation", class: this.hostCls },
            h("div", { class: "buttons-container", ref: (ref) => this.setButtonsContainerEl(ref) },
                h("slot", null),
                this.showIndicator &&
